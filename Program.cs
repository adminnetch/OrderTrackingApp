    ...
    private static async Task Main(string[] args)
    {
        ...
        using (var scope = app.Services.CreateScope())
        {
            ...
            try
            {
                ...
                var dbType = builder.Configuration.GetValue("Database:Provider", "sqlite");
        ...
        app.Use(async (context, next) =>
        {
            ...
            context.Response.Headers.Append("Content-Security-Policy",
                "default-src 'self'; " +
                "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.ckeditor.com https://office.projectcesare.ch; " +
                "style-src 'self' 'unsafe-inline' https://cdn.ckeditor.com https://office.projectcesare.ch; " +
                "img-src 'self' data:; " +
                "font-src 'self'; " +
                "frame-src https://office.projectcesare.ch;");
